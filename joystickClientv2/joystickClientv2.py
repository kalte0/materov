...
async def send(): # The main loop for this function. 
	...
	async with websockets.connect(uri) as websocket:
		...
		while True: 
			...
			await websocket.send(json_string) #send info + wait until done
			
			asyncio.sleep(0.5) # Maybe make delay a variable that can be more easily changed @ top of code at a later point?
